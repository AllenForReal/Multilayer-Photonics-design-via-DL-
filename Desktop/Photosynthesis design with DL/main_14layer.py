...
if __name__ == '__main__':
    ...
    wlmin = 300
    wlmax = 2500
    x0 = torch.tensor([107, 94, 89, 104, 161, 20, 126, 110, 79, 104, 12, 170, 47, 110])
    d = 50
    tmin = torch.maximum(x0 - d, torch.zeros(layer_dim)).to(device)
    tmax = (x0 + d).to(device)
    # x0 = torch.tensor([91.1, 51.6, 190.3, 19.8, 154.1, 109.3])
    tm = tmm(mat_lst=['air', 'Al2O3', 'SiC', 'MgF2', 'SiC', 'MgF2', 'Ag',
                      'Al2O3', 'SiC', 'SiO2', 'SiC', 'Ag', 'SiC', 'Al2O3', 'HfO2', 'SiO2'],
